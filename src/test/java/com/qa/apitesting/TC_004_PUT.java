...
public class TC_004_PUT {
	...
	public void test_01() {
		...
		// goto reqres app --> select PUT --> click the URL generated.
		...
		// given().body(req2.toJSONString()).when().put("https://reqres.in/api/users/2").then().statusCode(200);
		...
		.body(req2.toJSONString()).when().put("https://reqres.in/api/users")
		.then().statusCode(200)
